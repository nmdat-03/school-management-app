  ...
  switch (role) {
    ...
    case "teacher":
      query.AND = [
        {
          OR: [
            { exam: { lesson: { schedule: { teacherId: currentUserId! } } } },
            { assignment: { lesson: { schedule: { teacherId: currentUserId! } } } },
          ],
        },
      ];
      break;
  ...
  const data = dataRes
    .map((item) => {
      ...
      return {
        ...
        teacherName: assessment.lesson.schedule.teacher.name,
        teacherSurname: assessment.lesson.schedule.teacher.surname,
        score: item.score,
        className: assessment.lesson.schedule.class.name,
        startTime: isExam
